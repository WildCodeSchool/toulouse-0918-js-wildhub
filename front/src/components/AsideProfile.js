    ...
    return (
        <div className="col-lg-3 col-sm-12 my-5">
          <div className="row mx-auto d-flex justify-content-center ">
            ...
            <h1 className="pseudo col-sm-12 h1Eva">@Jacky-Tunning</h1>
            <h2 className="mb-5 col-sm-12 h2Eva"><span className="city">Toulouse, </span><span className="country">France</span></h2>   
            <h3 className="job h3Eva">Developpeur React</h3>
          </div>

          <div className="row mx-auto mt-5 d-flex justify-content-center">
            <h4 className="col-sm-12 h4Eva">Techologies utilisées:</h4>
            <ul className="technos row p-0 ulEva">
          ...
          <div className="row mx-auto mt-5  d-flex justify-content-center">
            <h4 className="h4Eva">Description:</h4>
